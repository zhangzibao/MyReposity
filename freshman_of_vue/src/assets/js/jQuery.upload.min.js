(function(a) {
	a.fn.upload = function(D) {
		...
		B = {
			...
			action: r.attr("action") ? r.attr("action") : "/add_act_2",
			size: r.attr("data-size") ? r.attr("data-size") : 20480,
			value: r.attr("data-value") ? r.attr("data-value") : ""
		};
		r.append(A.attr("data-num", B.num).attr("data-type", B.type)).append(d.attr("multiple", B.num > 1 ? "multiple": false)).append(b.attr("name", B.inputname)).addClass(B.num > 1 ? "multiple": "one").on("click", "li.add",
		function() {
			d.click()
