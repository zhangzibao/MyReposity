            ...
            <transition name="fold">
                <div class="shopcart-list" v-show="listShow">
                    ...
                    <div class="list-content" ref="listContent">
                        <ul>
                            <li class="food border-1px" v-for="food in selectFoods" v-if="food.nums > 0 ">

                                <span class="name">{{ food.name }}</span>
                                <div class="price">￥{{ food.price * food.nums }}</div>
  ...
  export default {
    ...
    methods: {
      ...
      pay() {
        ...
        let data = {}
        data['foods'] = this.selectFoods
        data['seller'] = 2
        data['pay_price'] = this.totalPrice
        router.push({
          name: 'pay',
          params: {
            dataObj: data
